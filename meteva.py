...
class Meteva:
    ...
    def calc_total_error(self):
        ...
        self.total_error = self.errors["max_temperature_error"] + self.errors["min_temperature_error"] + self.errors["wind_speed_error"] + self.errors["precip_error"]
